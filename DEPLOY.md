...
```cmd
# 直接放到包含JAR文件的目录
copy emorad-windows-amd64.exe E:\dump\intranet-gateway\emorad.exe
```
...
# 方式2安装后
E:\dump\intranet-gateway\emorad.exe --version
```
...
你的场景: `E:\dump\intranet-gateway` 目录中有多个Spring Boot JAR文件

```cmd
# 切换到目录
cd E:\dump\intranet-gateway

# 执行反编译
emorad.exe .

# 或者指定完整路径
emorad.exe E:\dump\intranet-gateway
```
...
📦 初始化反编译器...
✓ Java环境检测成功
✓ 使用CFR JAR: C:\Users\Administrator\.emorad\cfr\cfr-0.152.jar
📁 检测到目录,使用目录处理器
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

正在处理目录: E:\dump\intranet-gateway
📊 扫描结果: 4个JAR, 0个WAR, 0个CLASS文件
处理JAR文件: integrated-management-0.0.1.jar
处理JAR文件: intranet-gateway-0.0.1.jar
处理JAR文件: tce-tsf-trace-fetch-0.0.1.jar
处理JAR文件: tracing-api-0.0.1.jar
...
...
📂 输入路径: E:\dump\intranet-gateway
📁 输出路径: E:\dump\intranet-gateway\src
⏱️  总耗时: 45.23 秒
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
📄 详细报告已保存到: E:\dump\intranet-gateway\src\reports/
```
...
```cmd
# 反编译指定JAR
emorad.exe intranet-gateway-0.0.1.jar

# 指定输出目录
emorad.exe -o D:\decompiled intranet-gateway-0.0.1.jar
```
...
├── integrated-management-0.0.1.jar         # 原始JAR文件
├── intranet-gateway-0.0.1.jar
├── tce-tsf-trace-fetch-0.0.1.jar
└── tracing-api-0.0.1.jar
```
...
```json
{
  "inputPath": "E:\\dump\\intranet-gateway",
  "outputPath": "E:\\dump\\intranet-gateway\\src",
  "totalFiles": 1234,
  "successCount": 1230,
  "failureCount": 4,
  "results": [...]
